...
describe('JSONTransformer', () => {
    describe('transformJSON', () => {
        test('should transform a simple JSON array correctly', () => {
            ...
            const transformedJSON = JSON.stringify(Controller.transformJSON(jsonString));
        ...
        test('should transform an empty JSON array correctly', () => {
            ...
            const transformedJSON = Controller.transformJSON(inputJSON);
